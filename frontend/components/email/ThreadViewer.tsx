        ...
        <div className="rounded-lg border border-border bg-surface-elevated focus-within:border-accent">
          ...
          {draft.error && (
            <div className="border-t border-border px-3 py-2 text-small" style={{ color: "rgb(var(--urgent))" }}>
              Draft failed: {draft.error}. Is the backend running on :7330 and Ollama serving llama3.1:8b?
            </div>
          )}
          ...
          <div className="flex items-center justify-end gap-2 border-t border-border px-3 py-2">
            ...
            <button
              type="button"
              disabled
              title="Send is wired in v0.1 with Gmail modify scope"
              className="inline-flex items-center gap-1.5 rounded bg-accent px-3 py-1.5 text-small font-medium text-surface opacity-60 cursor-not-allowed"
