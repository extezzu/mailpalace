...
const SUMMARY_LANGS = [
  ...
  { code: "de-CH", label: "Schweizerdeutsch" },
  { code: "it", label: "Italiano" },
  { code: "nl", label: "Nederlands" },
  { code: "nl-BE", label: "Vlaams (België)" },
  ...
  return (
    <main className="mx-auto flex max-w-2xl flex-col gap-8 p-8">
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="text-small text-text-tertiary">
          Connected mailbox CRUD ships in v0.1 with the Gmail OAuth installed-app flow and the
          IMAP credentials sheet. Until then, the seed account is read-only.
        </p>
      </section>
    </main>
  );
