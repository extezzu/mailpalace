...
DEMO_EMAILS: list[dict[str, Any]] = [
    {
        ...
        "confidence": 0.94,
        "summary": "NordPay's security team wants a one-pager on the two open webhook signing questions, signed off before Wednesday's board review.",
    ...
    },
    {
        ...
        "confidence": 0.88,
        "summary": "Sven requested your review on PR #1842 (retry logic for token refresh, 14 files).",
    ...
    },
    {
        ...
        "classification": "important",
        "confidence": 0.81,
        "summary": "Oleksandr from KyivLabs wants a 20-minute call on Friday about your PolyPalace MCP server.",
    ...
    },
    {
        ...
        "confidence": 0.99,
        "summary": "Russian AI-infra digest. Anthropic MCP 2.0 streaming is the headline; worth a look if PolyPalace gets expanded.",
    ...
    },
    {
        ...
        "classification": "newsletter",
        "confidence": 0.99,
        "summary": "HN digest. Top story is someone shipping a weekend email AI agent (847 points). Possible competitor.",
    ...
    },
    {
        ...
        "classification": "important",
        "confidence": 0.92,
        "summary": "Skat.dk: your 2025 årsopgørelse is ready in TastSelv. Worth a quick check for adjustments.",
    ...
    },
    {
        ...
        "classification": "important",
        "confidence": 0.86,
        "summary": "Linear MAIL-12 assigned to you: draft generator should match the source language for Russian emails.",
